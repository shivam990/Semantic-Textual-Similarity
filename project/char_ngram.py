...
e=char_ngram(1,str1_l, str2_t)
f=char_ngram(1,str1_l, str2)
g=char_ngram(1,str1, str2_t)
h=char_ngram(1,str1, str2)
...
e=char_ngram(2,str1_l, str2_t)
f=char_ngram(2,str1_l, str2)
g=char_ngram(2,str1, str2_t)
h=char_ngram(2,str1, str2)
...
print('Character 1-gram Overlap                            Character 2-gram Overlap')
...
str1_t = ' '.join(str1_tt)
str2_t = ' '.join(str2_tt)
e=char_ngram(3,str1_l, str2_t)
f=char_ngram(3,str1_l, str2)
g=char_ngram(3,str1, str2_t)
h=char_ngram(3,str1, str2)
feature_3 = min(e, f, g, h)
feature_4 = max(e, f, g, h)
feature_5 = (e + f + g + h) / 4
if((e*f*g + e*f*h + e*g*h + f*g*h) == 0):
...
e=char_ngram(4,str1_l, str2_t)
f=char_ngram(4,str1_l, str2)
g=char_ngram(4,str1, str2_t)
h=char_ngram(4,str1, str2)
feature_7 = min(e, f, g, h)
feature_8 = max(e, f, g, h)
feature_9 = (e + f + g + h) / 4
if((e*f*g + e*f*h + e*g*h + f*g*h) == 0):
...
print('Character 3-gram Overlap                            Character 4-gram Overlap')
print(str(feature_3) + '                                                       ' + str(feature_7))
print(str(feature_4) + '                                                      ' + str(feature_8))
print(str(feature_5) + '                                                     ' + str(feature_9))
print(str(feature_6) + '                                      ' + str(feature_10))
